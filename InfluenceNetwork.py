...
def process_csv(message):
    ...
    prompt = (
        ...
        f"Salida esperada: Un JSON donde cada clave es el nombre de uno de los usuarios a los que se te pidio analizar sus opiniones y su valor es un número decimal entre 0 y 1, con dos decimales, como 0.21, 0.75 o 0.03, representando la postura general del usuario frente a {topic}. No retornes nada más."
    )
